...
export const stack = [
  {
    ...
    label: 'AI & LLMs',
    items: [
      { name: 'LangGraph & LangChain', level: 'EXPERT', score: 10 },
      { name: 'Multi-agent workflows', level: 'EXPERT', score: 10 },
      { name: 'RAG systems & hybrid retrieval', level: 'EXPERT', score: 10 },
      { name: 'Human-in-the-loop design', level: 'ADVANCED', score: 8 },
      { name: 'Prompt engineering', level: 'EXPERT', score: 10 },
      { name: 'Model Context Protocol', level: 'ADVANCED', score: 8 },
      { name: 'LLM Integration & APIs', level: 'EXPERT', score: 10 },
    ],
  },
  {
    ...
    items: [
      { name: 'Scikit-Learn', level: 'ADVANCED', score: 8 },
      { name: 'TensorFlow & Keras', level: 'ADVANCED', score: 8 },
      { name: 'PyTorch', level: 'INTERMEDIATE', score: 6 },
      { name: 'EDA & feature engineering', level: 'ADVANCED', score: 8 },
      { name: 'NumPy & Pandas', level: 'EXPERT', score: 10 },
      { name: 'Matplotlib & Seaborn', level: 'ADVANCED', score: 8 },
      { name: 'Neural Networks & CNNs', level: 'ADVANCED', score: 8 },
      { name: 'Reinforcement Learning (PPO)', level: 'ADVANCED', score: 8 },
      { name: 'NLP & Model Evaluation', level: 'ADVANCED', score: 8 },
    ],
  },
  {
    tag: 'languages_and_backend',
    label: 'Languages & Backend',
    items: [
      { name: 'Python', level: 'EXPERT', score: 10 },
      { name: 'TypeScript', level: 'ADVANCED', score: 8 },
      { name: 'SQL & PostgreSQL', level: 'ADVANCED', score: 8 },
      { name: 'FastAPI', level: 'EXPERT', score: 10 },
      { name: 'Express.js & Node.js', level: 'ADVANCED', score: 8 },
      { name: 'REST API Design & Flask', level: 'ADVANCED', score: 8 },
      { name: 'Redis & Celery', level: 'ADVANCED', score: 8 },
      { name: 'MongoDB', level: 'ADVANCED', score: 8 },
    ],
  },
  {
    tag: 'frontend_and_tools',
    label: 'Frontend & Tools',
    items: [
      { name: 'React & Vite', level: 'ADVANCED', score: 8 },
      { name: 'Next.js', level: 'ADVANCED', score: 8 },
      { name: 'Tailwind CSS', level: 'ADVANCED', score: 8 },
      { name: 'Streamlit', level: 'EXPERT', score: 10 },
      { name: 'Git & GitHub', level: 'ADVANCED', score: 8 },
      { name: 'Docker & Containers', level: 'ADVANCED', score: 8 },
      { name: 'pytest', level: 'INTERMEDIATE', score: 6 },
      { name: 'MoviePy & Jupyter', level: 'ADVANCED', score: 8 },
      { name: 'n8n Automation', level: 'ADVANCED', score: 8 },
    ],
  },
]
